...
from tbsim.configs.algo_config import (
    ...
    DiffuserConfig,
    DiffuserConfig_based_current_on_lane,
    DiffuserConfig_based_current_false,
    STRIVEConfig,
    SceneDiffuserConfig,
)
...
EXP_CONFIG_REGISTRY["trajdata_nusc_diff_based_current_on_lane"] = ExperimentConfig(
    train_config=NuscTrajdataTrainConfig(),
    env_config=NuscTrajdataEnvConfig(),
    algo_config=DiffuserConfig_based_current_on_lane(),
    registered_name="trajdata_nusc_based_current_on_lane"
)
EXP_CONFIG_REGISTRY["trajdata_nusc_diff_based_current_false"] = ExperimentConfig(
    train_config=NuscTrajdataTrainConfig(),
    env_config=NuscTrajdataEnvConfig(),
    algo_config=DiffuserConfig_based_current_false(),
    registered_name="trajdata_nusc_based_current_false"
)
...
def get_registered_experiment_config(registered_name):
    ...
    # 如果已注册的实验名称不在实验配置注册表中，则抛出KeyError异常
