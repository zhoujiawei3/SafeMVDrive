...
def parse_single_result(results_dir, eval_out_dir, save_hist_data=False, gt_hist_path=None):
    ...
    if args.estimate_dist:
        ...
        # hjson = compute_and_save_hist(os.path.join(results_dir, "data.hdf5"), eval_out_dir, save_hist_data, normalization_by=args.normalization_by, disable_control_on_stationary="None")
