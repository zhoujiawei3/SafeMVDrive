...
log_step= 200
print("Steps: ", steps)
MODEL_PATH_ROOT = "/data3/zhoujiawei/finetune/VLM-R1"

EXPERIMENT_NAME='SFT_7B_lora_nothingFreeze_no_type'
...
while True:
    # try:
    MODEL_PATH = f"{MODEL_PATH_ROOT}/{EXPERIMENT_NAME}/checkpoint-{steps}"
    # MODEL_PATH= "/data3/zhoujiawei/finetune/VLM-R1/100_random-bev-linearLR-hasbeta/checkpoint-100"
    OUTPUT_PATH = f"./logs_5_9/rgb_results_250_val_random3_bug_fix_after6frames_{EXPERIMENT_NAME}/step_{steps}.json"
