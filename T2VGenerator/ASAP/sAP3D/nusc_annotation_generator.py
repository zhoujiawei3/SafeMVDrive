...
def get_nusc_val_token(nusc):
    ...
    for sample_token in sample_tokens_all:
        ...
        val_scene_ids.append(scene_record['name'])
...
if __name__ == '__main__':
    ...
    # cp to ./data/nuscenes/
    final_path = os.path.join(opts.data_path, '{}_{}Hz_trainval_collide'.format(opts.ann_strategy, opts.ann_frequency))
