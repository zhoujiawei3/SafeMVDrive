...
def create_parser():
    parser = argparse.ArgumentParser(
        ...
        "driving dataset.")
    parser.add_argument(
        "-c", "--config-path", type=str, default="/home/zhoujiawei/OpenDWM/examples/ctsd_unimlvg_6views_video_generation.json", 
        help="The config to load the train model and dataset.")
    parser.add_argument(
        "-o", "--output-path", type=str, default="/data3/zhoujiawei/OpenDWM_out/test_generate/scene-0276_collision_A vehicle cuts in and collides with the ego vehicle_adv_3_startFrameIndex_96",
