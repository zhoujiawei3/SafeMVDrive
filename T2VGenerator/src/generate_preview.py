...
def create_parser():
    ...
    parser.add_argument(
        "--reference-frame-count", type=int, default=109,
        help="Save the nums of reference frame.")
    parser.add_argument(
        "-c", "--config-path", type=str, default="/home/zhoujiawei/OpenDWM/configs/unimlvg/generate_preview.json",
        help="The config to load the dataset.")
    parser.add_argument(
        "-o", "--output-path", type=str, default="/data3/zhoujiawei/OpenDWM_output/preview_dataset_collision",
