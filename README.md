...
By default, we use the output `obj_col` as the basis for calculating the **sample level collision rate** and `obj_box_col` as the basis for calculating the **scene level collision rate*
